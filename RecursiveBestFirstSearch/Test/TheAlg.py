...
mexicoMap = UndirectedGraph(dict(
    Acapulco=dict(Morelia=342, Ecatepec=305, Cuernavaca=236, Puebla=294, Oaxaca=321),
    Cuernavaca=dict(Ecatepec=69, Puebla=110),
    Ecatepec=dict(Morelia=226, Queretaro=185, Pachuca=68, Apizaco=96, Puebla=103),
    Guadalajara=dict(Tepic=183, Guadalupe=246, Aguascalientes=174, SanLuisPotosi=294, Leon=232, Morelia=250, Manzanillo=201),
    Manzanillo=dict(Guadalajara=201, Morelia=336),
    Morelia=dict(Leon=141, Queretaro=130)))

mexicoMap.locations = dict(
    Acapulco=(16.83, -99.88), Aguascalientes=(21.87, -102.29), Apizaco=(19.41, -98.13),
    Cuernavaca=(18.91, -99.2), Ecatepec=(19.6, -99.06), Guadalajara=(20.67, -103.34),
    Guadalupe=(-25.67, -100.25), Leon=(21.11, -101.68), Manzanillo=(19.05, -104.31),Morelia=(19.76, -101.18),Puebla=(19.03, -98.18),Queretaro=(20.58, -100.39),SanLuisPotosi=(22.15, -100.97),Tepic=(21.5, -104.89))
...
mexicoProblem = GraphProblem('Morelia', 'Acapulco', mexicoMap)
resultnode = RecursiveBFS(mexicoProblem)
